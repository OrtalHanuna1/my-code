...
def faster_vit_0_any_res(pretrained=False, **kwargs):
    ...
    model_path = kwargs.pop("model_path", '/Users/ortalhanuna/my-code/Tasks/SemanticSegmentation/20240603_Training_FasterViT_on_VOC_Segmentation_Dataset/weights/faster_vit_0.pth.tar')
